...
![Language](https://img.shields.io/badge/Language-Python-3776AB?style=flat-square) ![Stars](https://img.shields.io/github/stars/Devanik21/AI-Weather-App?style=flat-square&color=yellow) ![Forks](https://img.shields.io/github/forks/Devanik21/AI-Weather-App?style=flat-square&color=blue) ![Author](https://img.shields.io/badge/Author-Devanik21-black?style=flat-square&logo=github) ![Status](https://img.shields.io/badge/Status-Active-brightgreen?style=flat-square)

> AI Weather APP — an intelligent, interactive ML application built for real-world prediction and analysis.

---

**Topics:** `data-science` · `api` · `deep-learning` · `machine-learning` · `meteorology` · `neural-networks` · `streamlit` · `time-series` · `weather-forecasting` · `ensemble-weather-model`

## Overview

AI Weather APP is a machine learning web application built on Streamlit that provides a clean, accessible interface for a trained predictive model. The application takes structured user input, preprocesses it through a scikit-learn Pipeline, and returns model predictions with confidence scores and explanatory visualisations.
...
> **Key packages detected in this repo:** `streamlit` · `google-generativeai` · `pandas` · `plotly` · `matplotlib` · `folium` · `streamlit-folium` · `geopy` · `requests` · `pycountry`
...
```bash
git clone https://github.com/Devanik21/AI-Weather-App.git
cd AI-Weather-App
